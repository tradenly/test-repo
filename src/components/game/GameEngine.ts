...
export class GameEngine {
  ...
  update() {
    ...
    // Missile system - spawn every 45 seconds
  ...
  private drawMissile(missile: any) {
    this.ctx.save();
  ...
  private drawEnhancedPipe(pipe: any) {
  ...
  private drawEnhancedShieldCounter() {
