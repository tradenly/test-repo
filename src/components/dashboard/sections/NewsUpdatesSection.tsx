...
export const NewsUpdatesSection = ({ user }: NewsUpdatesSectionProps) => {
  ...
  const newsItems: NewsItem[] = [
    ...
    },
    {
      ...
      fullContent: "We're thrilled to announce the upcoming Initial DEX Offering (IDO) of the POOPEE token on the Cardano blockchain! The pre-sale will launch on the MINSWAP platform on july 28th 2025, offering early investors exclusive access to our native gaming token. POOPEE tokens will serve as the primary currency for all platform activities, including game entry fees, staking rewards, and marketplace transactions. Early pre-sale participants will receive bonus tokens and exclusive benefits including priority access to new games, enhanced staking rewards, and special NFT airdrops. The token will feature deflationary mechanics through regular burns, governance voting rights for platform decisions, and cross-platform utility across all our gaming ecosystem. This is a limited opportunity to get involved with the future of gaming on Cardano.",
      date: "2025-05-15",
      category: "Token",
      type: "event",
      isNew: true
