  ...
  const shareOnSocial = (platform: string) => {
    ...
    switch (platform) {
      ...
      case "facebook":
        ...
        break;
      case "instagram":
        // For Instagram, we'll copy the message and link and notify the user
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className={isMobile ? "space-y-3" : "flex gap-3"}>
            {/* First row - Twitter and Facebook (always visible) */}
            <div className="flex gap-3">
              <Button
                onClick={() => shareOnSocial("twitter")}
                variant="outline"
                size="sm"
                className="bg-blue-500 hover:bg-blue-600 border-blue-600 text-white flex-1"
                disabled={!getReferralLink()}
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-blue-600 hover:bg-blue-700 border-blue-700 text-white flex-1"
                disabled={!getReferralLink()}
              >
                <svg className="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Second row - Instagram (only show on desktop) */}
            {!isMobile && (
              <Button
