...
interface HighScoresLeaderboardProps {
  data: LeaderboardEntry[] | undefined;
  currentUserId: string;
}

export const HighScoresLeaderboard = ({ data, currentUserId }: HighScoresLeaderboardProps) => {
  ...
  const sortedData = [...data].sort((a, b) => b.highest_score - a.highest_score);
