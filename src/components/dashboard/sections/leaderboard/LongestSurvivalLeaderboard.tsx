...
interface LongestSurvivalLeaderboardProps {
  data: LeaderboardEntry[] | undefined;
  currentUserId: string;
}

export const LongestSurvivalLeaderboard = ({ data, currentUserId }: LongestSurvivalLeaderboardProps) => {
  ...
  const sortedData = [...data].sort((a, b) => b.longest_survival - a.longest_survival);
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-xl font-bold text-purple-400">
                    {formatTime(entry.longest_survival)}
                  </p>
                  <p className="text-sm text-gray-400">
                    survival time
                  </p>
